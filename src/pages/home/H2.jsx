    ...
    return (
        <div className='flex mt-20 flex-wrap justify-between'>
            ...
            {data.imgData.map((img, index) => (
                <div key={index} style={{background:`url(${img})`, backgroundRepeat:'no-repeat', backgroundSize:'cover', backgroundPosition:'center'}} className='h-[40vh] w-full lg:w-200 lg:h-[80vh] mt-10 lg:mt-0 px-3 lg:px-10'>
                </div>
            ))}
        </div>
    )
